...
export default function AbouMe() {
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-[rgb(28, 30, 31)]  ">
      ...
      <div className=" grid xl:grid-cols-12 ">
        <div className="xl:col-span-7   text-center xl:text-left ml-3 mr-3 xl:ml-14 2xl:ml-36 mt-12  ">
        ...
        <div className="xl:col-span-5 xl:mt-9  xl:ml-14 2xl:ml-10 mt-12 ml-5">
          ...
          <hr  className="2xl:opacity-0 opacity-50 mt-2 "/>
          <li className="list-none mt-5"> <a href="#" ><span className="font-semibold">Email:  </span> <span className="opacity-50 mt-2 text-[#20c997]">{email}</span></a></li>
          <hr  className="2xl:opacity-0 opacity-50 mt-2 "/>
