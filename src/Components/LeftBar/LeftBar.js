...
export default function LeftBar() {
   ...
   const activeSectionState = atom({
    key: "activeSectionState",
    default: null,
  });
  
   const activeMenuItemState = atom({
    key: "activeMenuItemState",
    default: "Home",
  });
  
   const showLeftBarState = atom({
    key: "showLeftBarState",
    default: true,
  });
  ...
  const [activeSection, setActiveSection] = useRecoilState(activeSectionState); // Use Recoil state
  const [activeMenuItem, setActiveMenuItem] = useRecoilState(activeMenuItemState); // Use Recoil state
  const [showLeftBar, setShowLeftBar] = useRecoilState(showLeftBarState); // Use Recoil state
  const [showMenu, setShowMenu] = useRecoilState(showMenuState); // Use Recoil state
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Add code to update activeMenuItem
      if (activeSection === "about") {
        setActiveMenuItem("about");
      } else if (activeSection === "whatido") {
        setActiveMenuItem("whatido");
  ...
  }, [activeSection, setActiveSection, setActiveMenuItem]);
